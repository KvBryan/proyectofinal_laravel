...
@section('content')  
    <div class="container mt-5">
        <h1 class="text-center text-primary mb-4">Crear Activo</h1>
        <div class="card mx-auto shadow p-4" style="max-width: 600px;">
            <form action="/activos/store" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion" rows="4" placeholder="Ingresa la descripción del activo"></textarea>
                    @error('descripcion')
                        <span class="invalid-feedback d-block" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
